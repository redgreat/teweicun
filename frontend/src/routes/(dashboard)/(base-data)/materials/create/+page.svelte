...
<script lang="ts">
	...
	function removeCustomAttribute(index: number) {
		form.custom_attributes = form.custom_attributes.filter((_, i) => i !== index);
	}
	...
	async function submit() {
		...
		try {
			...
			toast.error('新增失败: ' + (err?.message || err));
		} finally {
			submitting = false;
		}
	}
...
<div class="w-full space-y-6">
	<div class="flex items-center justify-between">
		<div class="flex items-center gap-3">
			...
			<h1 class="text-2xl font-bold tracking-tight">新增物料</h1>
		</div>
		...
		<div class="card-body space-y-6">
			<div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
				<div class="form-control">
					<label class="label" for="mat-category-id">
				...
				<div class="form-control">
					<label class="label" for="mat-code">
				...
				<div class="form-control">
					<label class="label" for="mat-name">
				...
				<div class="form-control">
					<label class="label" for="mat-unit">
				...
				<div class="form-control">
					<label class="label" for="mat-safety">
				...
				<div class="form-control lg:col-span-2">
					<label class="label py-0 pb-1" for="mat-remark">
