...
func ListCustomers(c *gin.Context) {
	...
	list, total, err := service.ListCustomers(c.Request.Context(), &q)
	if err != nil {
...
func CreateCustomer(c *gin.Context) {
	var req request.CreateCustomerReq
...
func UpdateCustomer(c *gin.Context) {
	...
	if err != nil {
		response.Error(c, errcode.NewAppError(errcode.ErrInvalidParam.Code, "Invalid customer ID", errcode.ErrInvalidParam.HTTPCode))
		return
	}
	...
	err = service.UpdateCustomer(c.Request.Context(), id, &req, userID, username)
	if err != nil {
		response.Error(c, err)
		return
	}
...
func DeleteCustomer(c *gin.Context) {
	...
	err = service.DeleteCustomer(c.Request.Context(), id, userID, username)
	if err != nil {
		response.Error(c, err)
		return
	}
